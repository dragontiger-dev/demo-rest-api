...
operation::query-events[snippets='response-body,curl-request,http-response,links']
...
operation::create-event[snippets='curl-request,http-request,http-response,request-headers,request-fields,response-headers,response-fields,links']
